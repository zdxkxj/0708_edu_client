        ...
        <div class="cart_info">
            ...
            <div class="cart_table">
                ...
                <div class="cart_course_list">
                    <CartItem v-for="(course,key) in cart_list" :key="key" :course="course"
                              @delete_course="del_cart(key)" @change_select="cart_total_price"></CartItem>
    ...
    export default {
        ...
        methods: {
            ...
            del_cart(index){
                    ...
                    this.$store.commit('add_cart',this.cart_list_.length);
                    this.cart_total_price();
            },
            components: {
